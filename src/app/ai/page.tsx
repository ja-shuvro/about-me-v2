...
export const metadata: Metadata = {
  title: 'MD. Jonaed Ali Shuvro // AI Search Canonical Developer Profile Summary',
  ...
  keywords: ['MD. Jonaed Ali Shuvro', 'Developer Profile', 'AI Crawler Feed', 'Flutter Specialist', 'Systems Engineer'],
  alternates: {
